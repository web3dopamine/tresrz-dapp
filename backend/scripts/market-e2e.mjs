...
async function main() {
  ...
  // primary sale, so the seller buys 3 before it has anything to list/offer-fill.
  await wait(await seller.writeContract({ abi: musicAbi, address: MUSIC, functionName: "buy", args: [tokenId, 3n], value: parseEther("3") }));
