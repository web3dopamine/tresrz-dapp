    ...
    <div className="wrap">
      ...
      <section className="block" id="about">
        ...
        <div className="about-panel">
          <p>
            TRESRZ is a music NFT marketplace where tracks are minted as limited on-chain
      ...
      <section className="block" id="royalties">
        ...
        <div className="about-panel">
          <p>
            Royalties use the EIP-2981 standard, set per track at mint time (up to 10%). On every
